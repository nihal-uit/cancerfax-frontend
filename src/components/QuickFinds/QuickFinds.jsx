      ...
      <ScrollAnimationComponent animationVariants={fadeIn}>
        <TopSection>
          ...
          <RightContent className='commContent_wrap'>
            <Description className='text-16'>{renderRichTextWithImages(content.description_block)}</Description>
          </RightContent>
        </TopSection>
        ...
        <FiltersContainer>
          ...
          <SelectWrapper>
            ...
            <SelectDisplay className={!selectedSpecialty ? 'placeholder' : ''}>
              {selectedSpecialty 
                ? specialtyOptions.find(s => s.value === selectedSpecialty)?.name || 'Select treatment'
                : 'Select treatment'}
            </SelectDisplay>
            <DropdownIcon>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
