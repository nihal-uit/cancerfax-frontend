...
const SECTIONS = [
  { id: "about", label: "About the doctor" },
  { id: "specialization", label: "Specialization" },
  { id: "procedures_performed", label: "Procedures Performed" },
  { id: "research_publications", label: "Research & Publications" },
                ...
                <div className="row g-6">
                  <div className="col-lg-7">
                    <div className="content-gap-20">
                      ...
                      <h3 className="title-3">About the Doctor</h3>
                  ...
                  <div className="col-lg-5">
                    <div className="content-gap-20">
                      <div>
                      <h4 className="f-w-600 mb-2">Prof. Shuhang Wang</h4>
                      <p className="text-16">
                        is a distinguished oncologist and clinical researcher affiliated with the Chinese Academy of Medical Sciences (CAMS) Cancer Center in Beijing, a leading institution in cancer treatment, research, and education in China. Her dual roles as Associate Chief Physician and Secretary of the Good Clinical Practice (GCP) Center highlight his expertise in both clinical oncology and the oversight of clinical trials.
                      </p>
                      </div>
                      <p className="text-16">Dr. Shuhang Wang graduated from Peking University and was Postdoctoral fellow at Mayo Clinic.</p>
                    </div>
                  </div>
                </div>

                <p className="text-16">
                  She is devoted to clinical trials of new antineoplastic drugs and their translational research, including the research and development of cell gene and therapeutic tumor vaccine products, etc.
                </p>
                <p className="text-16">
                  Dr. Wang is skilled in individualized targeted and immunotherapy for rare tumors and lung cancer, as well as multidisciplinary comprehensive treatment of advanced solid tumors. Focus on the mechanism research of antineoplastic drugs, and the research of tumor heterogeneity and immune microenvironment.
                </p>
                <p className="text-16">
                  Dr Wang published more than 40 articles as the first author in internationally renowned oncology journals such as Cancer Cell, JAMA Oncology, and Journal of Thoracic Oncology.
                </p>
                <p className="text-16">
                  Dr Wang has presided over or participated in several projects such as the construction of the clinical trial capacity improvement (GCP) platform, the National Natural Science Foundation of China, and ASCO LIFE.
                </p>
                ...
                <div className="row g-4">
                    ...
                    <Swiper
                      ...
                      <SwiperSlide>
                        <div className='doctorsDetails_info_slider'>
                          <img src="../images/doctors-slider-img-1.webp" alt="" />
                          <div className='doctorsDetails_info_slider_content'>
                            <div className='inner_container'>
                              <div className='commContent_wrap'>
                                <h5>Doctors name</h5>
                                <p className="text-14">Dr Bharat Patodiya, 4th Floor, Pi Cancer Care, Above Pi Electronics, Indira Nagar, Gachibowli, Hyderabad, India</p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className='doctorsDetails_info_slider'>
                          ...
                          <div className='doctorsDetails_info_slider_content'>
                            <div className='inner_container'>
                              <div className='commContent_wrap'>
                                <h5>Doctors name</h5>
                                <p className="text-14">CancerFax helps patients find cutting-edge treatments and ongoing clinical trials across top medical centers. From report review to travel support, we guide you every step of the way.</p>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="col-lg-5">
                    <SingleCard>
                      ...
                      <SingleCardTitle className='title-5 text_theme_dark mb-3'>Prof. Shuhand Wang | CAMS Cancer Center</SingleCardTitle>
                      <SingleCardDescription className='text-16 text_theme_dark'>
                        Prof. Shuhand Wang is presently working at the Cancer Center of the Chinese Academy of Medical Sciences (CAMS), one of China’s leading institutions for cancer research, diagnosis, and advanced treatment. His work at CAMS focuses on delivering innovative care and contributing to pioneering cancer research initiatives.
