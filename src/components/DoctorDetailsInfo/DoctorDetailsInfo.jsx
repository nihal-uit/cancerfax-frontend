                  ...
                  >
                    <div className="commContent_wrap content-gap-24">
                      <div className="row g-6">
                        ...
                        <p className="text-16 mt-4">{aboutData?.detailed_content || ''}</p>
                      </div>
                      <p className="text-16">
                        {aboutData?.extra_1 || ''}
                      </p>
                        ...
                        <div className="col-lg-7">
                          <div className='doctorsDetails_slider_wrapper'>
                            <Swiper
                              ...
                              className="commCircle_navigation"
                            >
                              {(aboutData?.hospitals_description || []).map((desc, idx) => (
                                <SwiperSlide key={idx}>
                                  <div className='doctorsDetails_info_slider'>
                                    <img src={aboutData?.doctor_image ? formatMedia(aboutData.doctor_image) : ''} alt={aboutData?.doctor_name || ''} />
                                    <div className='doctorsDetails_info_slider_content'>
                                      <div className='inner_container'>
                                        <div className='commContent_wrap'>
                                          <h5>{aboutData?.doctor_name || ''}</h5>
                                          <p className="text-14">{desc?.children?.map(d => d?.text).join(' ') || ''}</p>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
